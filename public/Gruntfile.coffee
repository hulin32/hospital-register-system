        ...
        less:
            components:
                files:
                    ...
                    'dist/css/register/select_time.css': ['src/css/register/select_time.less']
                    'dist/css/user/center.css': ['src/css/user/center.less']
                    'dist/css/user/feedback/feedback.css': ['src/css/user/feedback/feedback.less']
                    ...
                    'dist/css/user/register/register.css': ['src/css/user/register/register.less']
